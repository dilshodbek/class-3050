...
public class RemoteAddressBookServer implements Runnable {
    ...
    public static void main(String[] args) throws IOException, AddressBookException {
        ...
        AddressBookFactory.Builder builder = new AddressBookFactory.Builder(args[2]);
    ...
    public RemoteAddressBookServer(AddressBook addressBook, ServerSocket serverSocket,
    ...
    private static class Handler implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.err.println("I/O failure while talking to remote client. Aborting.");
                e.printStackTrace();
            }
        }

        private boolean handle(String[] request, PrintStream out) throws AddressBookException {
