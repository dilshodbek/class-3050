...
public class RemoteAddressBook implements AddressBook {
    ...
    public RemoteAddressBook(InetSocketAddress inetSocketAddress) throws AddressBookException {
        try {
            this.socket = new Socket(inetSocketAddress.getHostName(), inetSocketAddress.getPort());
            this.out = new PrintStream(socket.getOutputStream());
            this.in = new BufferedReader(new InputStreamReader(socket.getInputStream()));
        } catch (IOException e) {
            throw new AddressBookException("Failed to create socket to remote client", e);
        }
    }
    ...
    private List<String> request(String request, Object... args) throws AddressBookException {
        try {
            ...
            throw new AddressBookException("Failed to submit request [" + request + "]", e);
        }
    }
