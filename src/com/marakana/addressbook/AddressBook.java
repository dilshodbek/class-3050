...
public interface AddressBook {
     ...
     * 
     * @param email the email of the contact to get
     * @return the contact with the specified email or null if no such contact
     *         exists.
     * @throws AddressBookException if there is a problem getting this contact.
     ...
     * @throws AddressBookException if there is a problem storing this contact
     ...
     * @throws AddressBookException if there is a problem deleting this contact.
     * @throws NullPointerException if email is null
     */
     ...
     * 
     * @throws AddressBookException if there is a problem closing this address
     *             book.
     */
